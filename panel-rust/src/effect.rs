...
pub enum Effect {
    ...
    LoadInitialState,
    NewThread { display_name: String, provider: String },
    DeleteThread { real_index: usize },
    RenameThread { real_index: usize, name: String },
    PersistThread { real_index: usize },
    ...
    SendPrompt { real_index: usize, text: String },
    CancelGeneration { real_index: usize },
    RespondAgentRequest { real_index: usize, request_id: String, approve: bool },
    PermissionOptionSelected { real_index: usize, request_id: String, option: String },
    LoadOlderMessages { real_index: usize },
    LocalTerminalSpawn,
    LocalTerminalKill,
    LocalTerminalWrite { bytes: Vec<u8> },
    SaveSettings { doc: String },
    SetConfigOption { real_index: usize, key: String, value: String },
    SetMode { real_index: usize, mode: String },
    SaveDevMode { enabled: bool },
    McpServerCreate { real_index: usize, name: String, config: String },
    McpServerDelete { real_index: usize, name: String },
    McpServerEnabledChanged { real_index: usize, name: String, enabled: bool },
    ProfileCreate { real_index: usize, name: String, config: String },
    ProfileDelete { real_index: usize, name: String },
    AgentInstallRequested { real_index: usize, agent_id: String },
    SkillWrite { path: std::path::PathBuf, content: String },
    SkillDelete { path: std::path::PathBuf },
    SkillPromoteToGlobal { path: std::path::PathBuf },
    ...
    SetActiveProjectPath { path: Option<String> },
}
...
pub enum EffectResultMsg {
    ...
    ThreadPersisted { real_index: usize, result: Result<(), EffectError> },
    SessionAttached {
        real_index: usize,
